...
CREATE TABLE `addresses`  (
  ...
  `receiver_phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '收件人联系电话',
  ...
  `district` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '区/县名称',
  `detail_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '详细地址，如街道、门牌号等',
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '收货地址表，存储用户的收货地址信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `announcements`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '公告表，存储系统公告信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `carts`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '购物车表，存储用户的购物车信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `categories`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品分类表，存储商品的分类体系' ROW_FORMAT = Dynamic;
...
CREATE TABLE `customer_service_messages`  (
  ...
  `content_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '内容类型：text-文本，image-图片，file-文件',
  `read_status` bit(1) NOT NULL COMMENT '读取状态：0-未读，1-已读',
  `create_time` datetime NULL DEFAULT NULL COMMENT '发送时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '客服消息表，记录用户与客服的聊天记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `customer_service_sessions`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户评价备注',
  `complaint_status` int(11) NULL DEFAULT NULL COMMENT '投诉状态：0-无投诉，1-投诉中，2-已处理',
  `complaint_result` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '投诉处理结果说明',
  `is_penalty` bit(1) NULL DEFAULT NULL COMMENT '是否处罚商家：0-否，1-是',
  `penalty_content` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '处罚内容详情',
  `create_time` datetime NULL DEFAULT NULL COMMENT '记录创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '记录更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '客服会话表，记录用户与客服的会话信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `favorites`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '收藏表，存储用户收藏的商品' ROW_FORMAT = Dynamic;
...
CREATE TABLE `orders`  (
  ...
  `order_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '订单编号，系统生成，全局唯一',
  ...
  `payment_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付方式：支付宝、微信支付等',
  ...
  `refund_reason` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '退款原因说明',
  `create_time` datetime NULL DEFAULT NULL COMMENT '订单创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '订单更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `UK_order_no`(`order_no`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单表，存储用户订单信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `products`  (
  ...
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品简短描述',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品表，存储商品的基本信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `reviews`  (
  ...
  `reply` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商家回复内容',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品评价表，存储用户对商品的评价信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `search_histories`  (
  ...
  `user_id` bigint(20) NOT NULL COMMENT '用户ID，关联users表',
  `keyword` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '搜索关键词',
  `result_count` int(11) NULL DEFAULT NULL COMMENT '搜索结果数量',
  `create_time` datetime NULL DEFAULT NULL COMMENT '搜索时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '搜索历史表，记录用户的搜索记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `stores`  (
  ...
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '店铺简介描述',
  ...
  `license` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '营业执照图片URL',
  `create_time` datetime NULL DEFAULT NULL COMMENT '店铺创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '店铺信息更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '店铺表，存储商家店铺的基本信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `users`  (
  ...
  `username` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户名，用于登录和显示，唯一',
  `password` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '密码',
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '手机号码，用于账号验证和找回密码，唯一',
  `role` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户角色：ROLE_ADMIN-管理员，ROLE_MERCHANT-商家，ROLE_USER-普通用户',
  `status` int(11) NOT NULL COMMENT '账号状态：0-禁用，1-正常',
  `avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户头像URL地址',
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户信息表，存储系统用户的基本信息' ROW_FORMAT = Dynamic;
